            ...
            <div class="carousel-item active">
                <ul class="list-inline row  mx-auto">
                    ...
                    <li class="col-md-4"><img class="d-block img-fluid" src="https://risibank.fr/cache/stickers/d178/17866-full.png" alt="First slide"></li>
                     <li class="col-md-4"><img class="d-block img-fluid" src="https://vignette.wikia.nocookie.net/theclonewiki/images/2/27/Dark_Sidious_%282%29.PNG" alt="First slide"></li>
                </ul>
            </div>
